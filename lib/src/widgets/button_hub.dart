...
class ModuloButton extends ButtonClick {
  ModuloButton(super.value);
}

class DotButton extends ButtonClick {
  DotButton(super.value);
}
    ...
    return GridView.count(
      ...
      children: <Widget>[
        ...
        Button(
          value: '+/-',
          color: Theme.of(context).colorScheme.onPrimary,
          onTap: (value) => onButtonClick!(ModuloButton(value)),
        ),
        Button(
            value: '0',
            onTap: (value) => onButtonClick!(CommonButtonClick(value))),
        Button(
            value: '.',
            color: Theme.of(context).colorScheme.onPrimary,
            onTap: (value) => onButtonClick!(DotButton(value))),
        Button(
            value: '=',
